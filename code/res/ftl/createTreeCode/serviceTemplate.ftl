package com.da.service.${packageName}.${objectNameLower}.impl;
...
import com.da.entity.${packageName}.${objectName};
import com.da.util.PageData;
import com.da.service.${packageName}.${objectNameLower}.${objectName}Manager;
...
public class ${objectName}Service implements ${objectName}Manager{
	...
	public List<${objectName}> listTree(String parentId) throws Exception {
		...
		for(${objectName} daentity : valueList){
			daentity.setTreeurl("${objectNameLower}/list.do?${objectNameUpper}_ID="+daentity.get${objectNameUpper}_ID());
			daentity.setSub${objectName}(this.listTree(daentity.get${objectNameUpper}_ID()));
			daentity.setTarget("treeFrame");
		}
		return valueList;
	}
