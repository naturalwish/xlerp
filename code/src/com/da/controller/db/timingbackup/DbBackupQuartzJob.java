...
import com.da.service.db.brdb.impl.BRdbService;
import com.da.service.db.timingbackup.impl.TimingBackUpService;
...
public class DbBackupQuartzJob extends BaseController implements Job{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			String kackupPath = DbDA.getDbDA().backup(TABLENAME).toString();//调用数据库备份
