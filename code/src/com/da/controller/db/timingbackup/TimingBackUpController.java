package com.da.controller.db.timingbackup;
...
public class TimingBackUpController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		String DATIME = pd.getString("DATIME");									//时间规则
		...
		this.addJob(JOBNAME, DATIME, TABLENAME,TIMINGBACKUP_ID);				//添加任务
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("db/timingbackup/timingbackup_list");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("DATIME"));	//5
	 ...
	 */
	public void addJob(String JOBNAME, String DATIME, String TABLENAME, String TIMINGBACKUP_ID){
		Map<String,Object> parameter = new HashMap<String,Object>();
		parameter.put("TABLENAME", TABLENAME);
		parameter.put("TIMINGBACKUP_ID", TIMINGBACKUP_ID);
		QuartzManager.addJob(JOBNAME,JOB_GROUP_NAME, JOBNAME, TRIGGER_GROUP_NAME, DbBackupQuartzJob.class, DATIME ,parameter);
	}
