...
public class BrandController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("shop/goods/brand_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		int maxOrder = brandService.findMaxOrder(pd);
		pd.put("BRAND_ORDER",maxOrder+1);
		mv.setViewName("shop/goods/brand_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).getString("BRAND_DETAIL"));	    //3
			vpd.put("var4", varOList.get(i).getString("BRAND_ORDER"));	    //4
			vpd.put("var5", varOList.get(i).get("BRAND_VISIBLE").toString());	//5
			varList.add(vpd);
		}
