...
import com.da.service.shop.member.MemberManager;
...
public class MemberController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("shop/member/member_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("shop/member/member_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("MEMBER_EMAIL"));	    //2
			vpd.put("var3", varOList.get(i).getString("MEMBER_PASSWORD"));	    //3
			vpd.put("var4", varOList.get(i).getString("MEMBER_LEVEL"));	    //4
			vpd.put("var5", varOList.get(i).get("MEMBER_SEX").toString());	//5
			vpd.put("var6", varOList.get(i).getString("MEMBER_BIRTHDAY"));	    //6
			vpd.put("var7", varOList.get(i).get("MEMBER_CREDIT").toString());	//7
			vpd.put("var8", varOList.get(i).getString("MEMBER_QQ"));	    //8
			vpd.put("var9", varOList.get(i).getString("MEMBER_TEL"));	    //9
			vpd.put("var10", varOList.get(i).getString("MEMBER_PHONE"));	    //10
			vpd.put("var11", varOList.get(i).get("MEMBER_SHIPPOINT").toString());	//11
			varList.add(vpd);
		}
