...
public class InvoiceController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("shop/order/invoice_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("CODE",StringUtil.getId());
		mv.setViewName("shop/order/invoice_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("INVOICETIME"));	    //5
			vpd.put("var6", varOList.get(i).getString("STATUS"));	    //6
			vpd.put("var7", varOList.get(i).getString("OPERATOR"));	    //7
			vpd.put("var8", varOList.get(i).getString("OPERATION"));	    //8
			vpd.put("var9", varOList.get(i).getString("OPERATIONTIME"));	    //9
			varList.add(vpd);
		}
