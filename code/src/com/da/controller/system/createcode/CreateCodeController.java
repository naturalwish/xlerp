package com.da.controller.system.createcode;
...
import com.da.service.system.createcode.CreateCodeManager;
import com.da.util.AppUtil;
import com.da.util.DateUtil;
import com.da.util.DelAllFile;
import com.da.util.FileDownload;
import com.da.util.FileZip;
import com.da.util.Freemarker;
import com.da.util.Jurisdiction;
import com.da.util.PageData;
import com.da.util.PathUtil;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		String DATYPE = pd.getString("DATYPE");  					//模块类型			========参数0-2 类型，单表、树形结构、主表明细表
		...
		for(int i=0; i< zindex; i++){
			fieldList.add(pd.getString("field"+i).split(",da,"));	//属性放到集合里面
		}
		...
		}else if("fathertable".equals(DATYPE)){
			ftlPath = "createFaCode";	//主表
		}else if("sontable".equals(DATYPE)){
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",da,"+pd.getString("objectName").toUpperCase());	//表名
