package com.da.controller.system.user;
...
public class UserController extends BaseController {
	...
	public void deleteU(PrintWriter out) throws Exception{
		...
		DALOG.save(Jurisdiction.getUsername(), "删除系统用户："+pd);
		out.write("success");
		out.close();
	}
	...
	public ModelAndView saveU() throws Exception{
		...
		if(null == userService.findByUsername(pd)){	//判断用户名是否存在
			...
			DALOG.save(Jurisdiction.getUsername(), "新增系统用户："+pd.getString("USERNAME"));
	...
	public ModelAndView editU() throws Exception{
		...
		DALOG.save(Jurisdiction.getUsername(), "修改系统用户："+pd.getString("USERNAME"));
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public Object deleteAllU() throws Exception {
		...
		DALOG.save(Jurisdiction.getUsername(), "批量删除user");
		PageData pd = new PageData();
	...
	public ModelAndView exportExcel() throws Exception{
		DALOG.save(Jurisdiction.getUsername(), "导出用户信息到EXCEL");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try{
	...
	public ModelAndView readExcel(
		...
		DALOG.save(Jurisdiction.getUsername(), "从EXCEL导入到数据库");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
