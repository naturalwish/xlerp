package com.da.service.system.user.impl;
...
public class UserService implements UserManager{
	...
	@Value("${mall_upload_path}")
	private String mallUploadPath;


	@Value("${mall_upload_url}")
	private String mallUploadUrl;
	...
	public void updateLastLogin(PageData pd)throws Exception{
		...
		session.setAttribute("mall_url", mallUrl);
		session.setAttribute("mall_upload_path", mallUploadPath);
		session.setAttribute("mall_upload_url", mallUploadUrl);
	}
