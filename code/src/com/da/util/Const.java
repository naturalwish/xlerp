...
public class Const {
	...
	public static final String LOGIN = "/daadmin/login.do";					//登录地址
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(static)|(main)|(websocket)|(daadmin)|(web)|(da_static_1)|(da_static_2)|(da_static_3)|(da_static_4)|(ueditor)|(index)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
