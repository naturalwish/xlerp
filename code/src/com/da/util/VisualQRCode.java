...
public class VisualQRCode {
	 ...
	 * @throws IOException
	 */
	public static void createQRCode(String content, String bgPath,String logoPath, String outPath, char Level, Color DF, Integer startX, Integer startY, Integer QRCodeWidth, Boolean isDeformation,
		...
		System.out.println(bgImageHeight);
		System.out.println(bgImageWidth);
		...
		g.drawImage(img, 2150, 2050, 600, 600, null); // 60,60是距离gs两个边的距离，45,45是中间logo的大小
		g.dispose();
