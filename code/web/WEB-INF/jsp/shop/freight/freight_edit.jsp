                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        ...
                                        <td><input type="number" name="FREIGHT_PRICE" id="FREIGHT_PRICE"
                                                   value="${pd.FREIGHT_PRICE}" maxlength="32" placeholder="这里输入运费价格"
                                                   title="运费价格" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td style="width:75px;text-align: right;padding-top: 13px;">免邮价格:</td>
                                        <td><input type="number" name="FREIGHT_FREE_PRICE" id="FREIGHT_FREE_PRICE"
                                                   value="${pd.FREIGHT_FREE_PRICE}" maxlength="32"
                                                   placeholder="这里输入免邮价格" title="免邮价格" style="width:98%;"/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
