...
<body class="no-skin">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.ATTRIBUTE}</td>
											<td class='center'>${var.ATTRIBUTENUM}</td>
											<td class='center'>${var.ATTRIBUTEPRICE}</td>
											<td class='center'>${var.MARKETPRICE}</td>
											<td class='center'>${var.SECKILLPRICE}</td>
											<td class="center">
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>attribute/goAdd.do?GOODS_ID=${pd.GOODS_ID}';
			 diag.Width = 450;
			 diag.Height = 355;
