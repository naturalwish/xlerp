...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="goods/deleteList.do" method="post" name="Form" id="Form">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.MEMBER_PRICE}</td>
											<td style="width: 100px;" class="center">
												<c:if test="${var.GOODS_FORSALE == '0' }"><span class="label label-important arrowed-in">下架</span></c:if>
												<c:if test="${var.GOODS_FORSALE == '1' }"><span class="label label-success arrowed">上架</span></c:if>
											</td>
											<td style="width: 100px;" class="center">
											...
											<td class='center'><img src="<%=mallUploadUrl%>${var.GOODS_PIC}" alt="${var.GOODS_NAME}" height="60px" width="60px" width="100"></td>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.del == 1 }">
													<a class="btn btn-xs btn-danger" onclick="undel('${var.GOODS_ID}');">
														<i class="ace-icon fa fa-trash-o bigger-120" title="恢复"></i>
													</a>
													</c:if>
												</div>
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="undel('${var.GOODS_ID}');" class="tooltip-error" data-rel="tooltip" title="恢复">
																	<span class="red">
	...
	<script type="text/javascript">
		...
		//恢复
		function undel(Id){
			bootbox.confirm("确定要恢复吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>goods/undelete.do?GOODS_ID="+Id+"&tm="+new Date().getTime();
