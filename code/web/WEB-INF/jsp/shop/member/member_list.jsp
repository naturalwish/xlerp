								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.MEMBER_EMAIL}</td>
											<td class='center'>${var.MEMBER_PASSWORD}</td>
											<td class='center'>${var.MEMBER_LEVEL}</td>
											<td class='center'>${var.MEMBER_SEX}</td>
											<td class='center'>${var.MEMBER_BIRTHDAY}</td>
											<td class='center'>${var.MEMBER_CREDIT}</td>
											<td class='center'>${var.MEMBER_QQ}</td>
											<td class='center'>${var.MEMBER_TEL}</td>
											<td class='center'>${var.MEMBER_PHONE}</td>
											<td class='center'>${var.MEMBER_SHIPPOINT}</td>
											<td class="center">
