						...
						<form action="order/list.do" method="post" name="Form" id="Form">
							...
							<table style="margin-top:5px;">
								<tr>
									...
									<td><a href="order/list?status=0" class="btn btn-xs" style="width: 90px">待付款</a></td>
									...
									<td><a href="order/list?status=5" class="btn btn-xs" style="width: 90px">待评价</a></td>
									<td><a href="order/list?status=6" class="btn btn-xs" style="width: 90px">交易成功</a></td>
									<td><a href="order/list?status=99" class="btn btn-xs" style="width: 90px">已关闭</a></td>
												...
												<tr style="background: #dfe9f6">
													...
													<td colspan="1" class="center">
														...
														<div class="hidden-sm hidden-xs btn-group">
															<c:if test="${qx.edit == 1 && var.status !=99}">
																<a class="btn btn-xs btn-success" title="编辑" href="order/order?order_id=${var.order_id}">
																	<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
																</a>
																<a class="btn btn-xs btn-warning" title="关闭" onclick="orderClose('${var.order_id}');">
																	<i class="ace-icon fa fa-close bigger-120" title="关闭"></i>
																</a>
																<a class="btn btn-xs btn-default" title="退货" onclick="orderReturn('${var.order_id}');">
																	<i class="ace-icon fa fa-share-square-o bigger-120" title="退货"></i>
																</a>
															</c:if>
															<c:if test="${qx.del == 1 && var.status ==99}">
