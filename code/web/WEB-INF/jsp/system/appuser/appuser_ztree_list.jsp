...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="happuser/treeList.do" method="post" name="userForm" id="userForm">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center"><i class="ace-icon fa fa-money bigger-110 hidden-480"></i>订单总额</th>
									<th class="center"><i class="ace-icon fa fa-money bigger-110 hidden-480"></i>佣金</th>
								...
								<c:when test="${not empty userList}">
									...
									<c:forEach items="${userList}" var="user" varStatus="vs">
										<tr>
											...
											<td class="center">${user.ORDER_TOTAL}</td>
											<td class="center">${user.COMMISION_TOTAL}</td>
											...
											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-success" title="一级佣金" onclick="fenxiaoList('${user.USER_ID}',1);">一级订单
														<i class="ace-icon fa fa-file-o bigger-120" title="查看评论"></i>
													</a>
													<a class="btn btn-xs btn-success" title="二级佣金" onclick="fenxiaoList('${user.USER_ID}',2);">二级订单
														<i class="ace-icon fa fa-file-o bigger-120" title="查看评论"></i>
													</a>
												</div>
											</td>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
 	...
 	<script type="text/javascript">
        ...
        //分销列表
        function fenxiaoList(userId,level){
            top.jzts();
            var diag = new top.Dialog();
            diag.Drag=true;
            diag.Title ="分销列表";
            diag.URL = '<%=basePath%>order/fenxiaoList.do?USER_ID='+userId+'&LEVEL='+level;
            diag.Width = 1100;
            diag.Height = 600;
