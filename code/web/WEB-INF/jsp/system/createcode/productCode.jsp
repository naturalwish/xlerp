					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 10px;">
							<tr>
								...
								<td>
									<select name="DATYPE" id="DATYPE" data-placeholder="请选择数据库"  style="vertical-align:top;width: 87px;" onchange="selectType(this.value)">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:com.da.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td><input type="text" name="tabletop" id="tabletop" value="${msg == 'add' ? 'TB_' : ''}${fn:split(pd.TABLENAME, ',da,')[0]}" placeholder="这里输入表前缀" style="width:156px" title="表前缀"/></td>
							</tr>
						</table>
