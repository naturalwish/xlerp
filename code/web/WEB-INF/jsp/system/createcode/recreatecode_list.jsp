...
<body class="no-skin">
										...
										<div style="float: left;">
											<table>
												<tr>
													...
													<td>&nbsp;端口：</td>
													<td><input type="number" name="dbport" id="dbport" value="13306"  maxlength="10" placeholder="输入端口" title="端口"/></td>
												</tr>
												...
												<tr>
													...
													<td>&nbsp;密码：</td>
													<td><input type="password" name="password" id="password" value="hnda#@!"  maxlength="32" placeholder="输入密码" title="密码"/></td>
													<td>&nbsp;库名：</td>
													<td><input type="text" name="databaseName" id="databaseName" value="dashop"  maxlength="32" placeholder="输入数据库名" title="数据库名"/></td>
												</tr>
											</table>
										</div>
	...
	<script type="text/javascript">
		...
		function selectDb(value){
			$("#dbAddress").val('192.168.0.99');	//连接地址
			if("mysql" == value){
				$("#dbport").val(13306);				//端口
				$("#username").val('root');			//用户名
				$("#databaseName").val('dashop');			//库名
