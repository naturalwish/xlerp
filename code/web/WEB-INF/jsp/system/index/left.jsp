<div id="sidebar" class="sidebar                  responsive">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						...
						<button class="btn btn-info" onclick="changeMenus('index');" title="商城管理">
							<i class="ace-icon fa fa-pencil"></i>
						</button>
						
						<button class="btn btn-success" onclick="changeMenus('2');" title="内容管理">
							<i class="ace-icon fa fa-signal"></i>
						</button>

						<!-- #section:basics/sidebar.layout.shortcuts -->
						<button class="btn btn-warning" onclick="changeMenus('1');" title="系统菜单">
							<i class="ace-icon fa fa-book"></i>
						</button>

						<button class="btn btn-danger" onclick="changeMenus('4');" title="测试用例">
