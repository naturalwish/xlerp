								...
								<c:choose>
									...
									<tr>
										...
										<td class='center'><i class="${menu.MENU_ICON }">&nbsp;</i>
											...
											<span class="label label-success arrowed">系统菜单</span>
											</c:if>
											<c:if test="${menu.MENU_TYPE == '2' }">
											<span class="label label-important arrowed-in">内容管理</span>
											</c:if>
											<c:if test="${menu.MENU_TYPE == '3' }">
											<span class="label label-purple arrowed">商城管理</span>
											</c:if>
											<c:if test="${menu.MENU_TYPE == '4' }">
											<span class="label label-primary arrowed-right">测试用例</span>
											</c:if>
											</c:if>
										</td>
