					...
					<form action="key/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="PARNER" id="PARNER" value="${pd.PARNER}" maxlength="100" placeholder="这里输入商户号" title="商户号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">商户密钥:</td>
								<td><input type="text" name="PARNER_KEY" id="PARNER_KEY" value="${pd.PARNER_KEY}" maxlength="100" placeholder="这里输入商户密钥" title="商户密钥" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">域名:</td>
								<td><input type="text" name="WEB_SITE" id="WEB_SITE" value="${pd.WEB_SITE}" maxlength="100" placeholder="这里输入域名" title="域名" style="width:98%;"/></td>
							</tr>
							<tr>
